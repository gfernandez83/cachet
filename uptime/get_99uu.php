...
$sql_query = "select value,updated_at from (select * from metric_points where metric_id = 1 and updated_at>=DATE_SUB(NOW(), interval 3 hour) order by id desc) sub order by id asc";
